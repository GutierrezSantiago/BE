...
import utn.frc.backend.tutor.sac.dal.DBAlumno;
...
public class JDBC {
    ...
    public static final String H2_URL = "jdbc:h2:file:/t/dbdata/sac/sacdb";
    ...
    private static void listAlumnos(List<Alumno> alumnos) {
        ...
        for (Alumno alumno : alumnos) {
            System.out.println(Util.rPad(alumno, 80, 8));
        }
    }
