...
public class Persona {
    ...
    private void cloneFrom(Persona persona) {
    ...
    private void cloneFrom(Persona persona, Integer pid) {
        this.pid = persona.pid;
        cloneFrom(persona);
    }
    ...
    public Persona update(Persona persona, Integer pid) {
        cloneFrom(persona, pid);
        return this;
    }
